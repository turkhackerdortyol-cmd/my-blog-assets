...
function loadRecentComments(){var target=document.getElementById("vb-comments-target");if(!target)return;target.setAttribute("data-loaded","1");target.innerHTML='<div style="padding:20px;text-align:center;color:#64748b;">'
...
function load404RecentTopics(){
  ...
  cachedFetch('/feeds/posts/summary?alt=json&max-results=10').then(function(data){
    ...
    if(!entries.length){
      target.innerHTML='<div style="padding:18px;text-align:center;color:#64748b;">Henüz forum konusu yok.</div>';
      return;
    }
    var html='';
    ...
    target.innerHTML='<div style="padding:18px;text-align:center;color:#64748b;">Konular yüklenemedi.</div>';
  });
}
